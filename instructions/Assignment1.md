...
### Due: Monday 09/16, 11:59:59pm EST

**Ensure you are using **[Go 1.19.1](https://go.dev/doc/go1.19)**! Notably, the `max()` and `min()` built-in functions were added in Go 1.21, will not compile on the grading server, and have caused problems for many students in the past. **Triple check your go version**: `go version`.**
